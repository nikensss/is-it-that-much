...
DB_CONTAINER_NAME="is-it-that-much-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=is-it-that-much -d -p 5432:5432 docker.io/postgres
