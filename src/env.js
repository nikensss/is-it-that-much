...
export const env = createEnv({
  ...
  server: {
    ...
    CLERK_SIGN_OUT_FALLBACK_REDIRECT_URL: z.string(),
    CLERK_SECRET_KEY: z.string().min(1),
    CLERK_WEBHOOKS_SECRET: z.string().min(1),
  ...
  runtimeEnv: {
    ...
    CLERK_SIGN_IN_FALLBACK_REDIRECT_URL: process.env.NEXT_PUBLIC_CLERK_SIGN_IN_FALLBACK_REDIRECT_URL,
    CLERK_SIGN_UP_FALLBACK_REDIRECT_URL: process.env.NEXT_PUBLIC_CLERK_SIGN_UP_FALLBACK_REDIRECT_URL,
    CLERK_SIGN_OUT_FALLBACK_REDIRECT_URL: process.env.NEXT_PUBLIC_CLERK_SIGN_OUT_FALLBACK_REDIRECT_URL,
