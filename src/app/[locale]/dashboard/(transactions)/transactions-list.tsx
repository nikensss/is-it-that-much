...
import { SharedExpenseRow } from '~/app/[locale]/dashboard/(transactions)/shared-expense-row.client';
import { SettlementRow } from '~/app/[locale]/dashboard/(transactions)/settlement-row';
import { PersonalTransactionRow } from '~/app/[locale]/dashboard/(transactions)/personal-transaction-row.client';
